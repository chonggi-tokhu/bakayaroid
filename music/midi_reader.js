/* from https://github.com/fraigo/javascript-midi-player/tree/master/midiplayer */
var UTF8 = {
...
function MIDIFileHeader(buffer) {
    ...
    if (!buffer) {
        ...
        var data00 = this.datas;
        console.log((function () {
            var rtv = ''; for (var i = 0; i < data00.byteLength; i++) {
                rtv += data00.getUint8(i);
            }
            return rtv;
        })())
...
MIDIFile.prototype.loadSong = function (buffer, strictMode, cbfunc) {
    var track;
    var curIndex;
    var i;
    var j;
    ...
    if (typeof cbfunc === 'function') cbfunc(this);
}
